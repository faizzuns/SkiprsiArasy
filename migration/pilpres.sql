...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 13, 2019 at 01:11 AM
...
CREATE TABLE `answersheet` (
  ...
  `tendency_1` int(11) DEFAULT NULL,
  `tendecy_2` int(11) DEFAULT NULL,
  `id_news` int(11) DEFAULT NULL,
  `termo_1` int(11) DEFAULT NULL,
  `termo_2` int(11) DEFAULT NULL,
  `dbrief_1` int(11) DEFAULT NULL,
  `dbrief_2` int(11) DEFAULT NULL,
  `distract` int(11) DEFAULT NULL,
  `correction` int(11) DEFAULT NULL,
  `first_pick` varchar(15) DEFAULT NULL
...
CREATE TABLE `user` (
  ...
  `regency` varchar(30) DEFAULT NULL,
